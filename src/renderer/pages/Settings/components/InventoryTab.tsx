...
import type { InventorySettings } from "../../../api/system_config";
...
const InventoryTab: React.FC<Props> = ({ settings, onUpdate }) => {
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-[var(--text-primary)]">Inventory Settings</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="auto_reorder_enabled" className="text-sm text-[var(--text-secondary)]">
            Enable Auto Reorder
          </label>
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="windows-checkbox"
          />
          <label htmlFor="allow_negative_stock" className="text-sm text-[var(--text-secondary)]">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) => onUpdate("inventory_sync_enabled", e.target.checked)}
            className="windows-checkbox"
          />
          <label htmlFor="inventory_sync_enabled" className="text-sm text-[var(--text-secondary)]">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onUpdate("reorder_level_default", parseInt(e.target.value) || 0)}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onUpdate("reorder_qty_default", parseInt(e.target.value) || 0)}
            className="windows-input w-full"
            min="0"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onUpdate("stock_alert_threshold", parseInt(e.target.value) || 0)}
            className="windows-input w-full"
            min="0"
          />
        </div>
