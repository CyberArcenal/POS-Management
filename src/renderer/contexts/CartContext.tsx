...
//         showError(`Insufficient stock. Available: ${product.stockQty}`);
//         return false;
//       }
...
//         costPrice: product.price || undefined,
//         profit: product.price ? (product.price - product.price) * quantity : undefined,
//       };
