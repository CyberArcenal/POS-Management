// src/renderer/components/CustomerSelect.tsx
...
interface CustomerSelectProps {
  ...
  disabled?: boolean;
  placeholder?: string;
  showLoyalty?: boolean; // ipakita ang loyalty points
  className?: string;
}
...
const CustomerSelect: React.FC<CustomerSelectProps> = ({
  ...
  useEffect(() => {
    const loadCustomers = async () => {
      setLoading(true);
      try {
        // Puwede ring gumamit ng search params, pero simple muna
        ...
        console.error("Hindi ma-load ang mga customer:", error);
      } finally {
        setLoading(false);
      }
    };
